...
@Component({
  selector: 'app-pregnant-womenlist',
  templateUrl: './pregnant-womenlist.component.html',
  styleUrls: ['./pregnant-womenlist.component.sass']
})
export class PregnantWomenlistComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.patientdataService.womanList(womanList).subscribe(
      (result) => {
  ...
  deleteRecord() {
    ...
    this.patientdataService.deleteWomen(deleteData).subscribe(
      (result) => {
        Swal.fire(
          '',
