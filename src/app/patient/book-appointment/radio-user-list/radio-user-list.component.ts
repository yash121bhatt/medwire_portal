...
@Component({
  selector: 'app-radio-user-list',
  templateUrl: './radio-user-list.component.html',
  styleUrls: ['./radio-user-list.component.sass']
})
export class RadioUserListComponent implements OnInit {
