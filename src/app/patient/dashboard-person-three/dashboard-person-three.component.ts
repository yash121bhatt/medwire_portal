...
@Component({
  selector: 'app-dashboard-person-three',
  templateUrl: './dashboard-person-three.component.html',
  styleUrls: ['./dashboard-person-three.component.sass']
})
export class DashboardPersonThreeComponent implements OnInit {
