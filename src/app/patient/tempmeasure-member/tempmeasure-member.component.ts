...
@Component({
  selector: 'app-tempmeasure-member',
  templateUrl: './tempmeasure-member.component.html',
  styleUrls: ['./tempmeasure-member.component.sass']
})
export class TempmeasureMemberComponent implements OnInit {
