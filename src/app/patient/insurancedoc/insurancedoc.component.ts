...
@Component({
  selector: 'app-insurancedoc',
  templateUrl: './insurancedoc.component.html',
  styleUrls: ['./insurancedoc.component.sass']
})

export class InsurancedocComponent {
  ...
  onSubmit(fData: any,formDirective: FormGroupDirective) {
    ...
    if (this.labreportForm.invalid) {
      ...
      this.form.append('type','insurance_document');
