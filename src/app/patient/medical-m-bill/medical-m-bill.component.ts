...
@Component({
  selector: 'app-medical-m-bill',
  templateUrl: './medical-m-bill.component.html',
  styleUrls: ['./medical-m-bill.component.sass']
})
export class MedicalMBillComponent {
  maxDate = new Date();
  ...
  onSubmit(fData: any,formDirective: FormGroupDirective) {
    ...
    if (this.labreportForm.invalid) {
      ...
      this.form.append('type','all_bill');
