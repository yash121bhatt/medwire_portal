...
@Component({
  selector: 'app-edit-surgical-history',
  templateUrl: './edit-surgical-history.component.html',
  styleUrls: ['./edit-surgical-history.component.sass']
})
export class EditSurgicalHistoryComponent implements OnInit {
