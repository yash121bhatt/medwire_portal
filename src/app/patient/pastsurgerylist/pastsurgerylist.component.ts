...
@Component({
  selector: 'app-pastsurgerylist',
  templateUrl: './pastsurgerylist.component.html',
  styleUrls: ['./pastsurgerylist.component.sass']
})
export class PastsurgerylistComponent implements OnInit {
