...
@Component({
  selector: 'app-baby-growth-view-list',
  templateUrl: './baby-growth-view-list.component.html',
  styleUrls: ['./baby-growth-view-list.component.sass']
})
export class BabyGrowthViewListComponent implements OnInit {
