...
@Component({
  selector: 'app-pastsurgmemberlist',
  templateUrl: './pastsurgmemberlist.component.html',
  styleUrls: ['./pastsurgmemberlist.component.sass']
})
export class PastsurgmemberlistComponent implements OnInit {
