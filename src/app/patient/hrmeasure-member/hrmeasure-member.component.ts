...
@Component({
  selector: 'app-hrmeasure-member',
  templateUrl: './hrmeasure-member.component.html',
  styleUrls: ['./hrmeasure-member.component.sass']
})
export class HrmeasureMemberComponent implements OnInit {
  Users: USERS[] = [{
