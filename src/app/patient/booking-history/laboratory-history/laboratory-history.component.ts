...
@Component({
  ...
  styleUrls: ['./laboratory-history.component.sass']
})
export class LaboratoryHistoryComponent implements OnInit {
 ...
 fetch(_cb: (data: any) => void) {
   ...
   this.patientServiceService.patientRadioHistory(data).subscribe(
     (result: any) => {
