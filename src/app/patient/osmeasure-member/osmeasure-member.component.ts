...
@Component({
  selector: 'app-osmeasure-member',
  templateUrl: './osmeasure-member.component.html',
  styleUrls: ['./osmeasure-member.component.sass']
})
export class OsmeasureMemberComponent {
  Users: USERS[] = [{
