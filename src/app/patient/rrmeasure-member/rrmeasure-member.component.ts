...
@Component({
  selector: 'app-rrmeasure-member',
  templateUrl: './rrmeasure-member.component.html',
  styleUrls: ['./rrmeasure-member.component.sass']
})
export class RrmeasureMemberComponent implements OnInit {
  Users: USERS[] = [{
