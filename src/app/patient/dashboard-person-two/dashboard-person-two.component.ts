...
@Component({
  selector: 'app-dashboard-person-two',
  templateUrl: './dashboard-person-two.component.html',
  styleUrls: ['./dashboard-person-two.component.sass']
})
export class DashboardPersonTwoComponent implements OnInit {
