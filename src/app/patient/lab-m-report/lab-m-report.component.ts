...
@Component({
  selector: 'app-lab-m-report',
  templateUrl: './lab-m-report.component.html',
  styleUrls: ['./lab-m-report.component.sass']
})
export class LabMReportComponent {
  ...
  onSubmit(fData: any,formDirective: FormGroupDirective) {
    ...
    if (this.labreportForm.invalid) {
      ...
      this.form.append('type','patient_lab_report');
