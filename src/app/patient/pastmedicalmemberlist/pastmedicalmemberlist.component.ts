...
@Component({
  selector: 'app-pastmedicalmemberlist',
  templateUrl: './pastmedicalmemberlist.component.html',
  styleUrls: ['./pastmedicalmemberlist.component.sass']
})
export class PastmedicalmemberlistComponent implements OnInit {
    Users: USERS[] = [];
