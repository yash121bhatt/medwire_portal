...
@Component({
  selector: 'app-dashboard-person-four',
  templateUrl: './dashboard-person-four.component.html',
  styleUrls: ['./dashboard-person-four.component.sass']
})
export class DashboardPersonFourComponent implements OnInit {
