...
@Component({
  selector: 'app-insurance-m-doc',
  templateUrl: './insurance-m-doc.component.html',
  styleUrls: ['./insurance-m-doc.component.sass']
})
export class InsuranceMDocComponent implements OnInit {
