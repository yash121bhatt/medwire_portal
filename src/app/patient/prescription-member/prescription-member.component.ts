...
@Component({
  selector: 'app-prescription-member',
  templateUrl: './prescription-member.component.html',
  styleUrls: ['./prescription-member.component.sass']
})
export class PrescriptionMemberComponent implements OnInit {
  Users: USERS[] = [{
