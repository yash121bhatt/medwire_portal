...
@Component({
  selector: 'app-latest-test-report-member',
  templateUrl: './latest-test-report-member.component.html',
  styleUrls: ['./latest-test-report-member.component.sass']
})
export class LatestTestReportMemberComponent implements OnInit {
  Users: USERS[] = [  ]; 
