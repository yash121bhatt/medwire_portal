...
@Component({
  selector: 'app-bmimeasure-member',
  templateUrl: './bmimeasure-member.component.html',
  styleUrls: ['./bmimeasure-member.component.sass']
})
export class BmimeasureMemberComponent implements OnInit {
