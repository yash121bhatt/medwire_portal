...
@Component({
  selector: 'app-vacination-m-report',
  templateUrl: './vacination-m-report.component.html',
  styleUrls: ['./vacination-m-report.component.sass']
})
export class VacinationMReportComponent {
  ...
  onSubmit(fData: any,formDirective: FormGroupDirective) {
    ...
    if (this.labreportForm.invalid) {
      ...
      this.form.append('type','vaccination');
