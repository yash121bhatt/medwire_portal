...
@Component({
  selector: 'app-lab-test-member',
  templateUrl: './lab-test-member.component.html',
  styleUrls: ['./lab-test-member.component.sass']
})
export class LabTestMemberComponent implements OnInit {
  Users: USERS[];
