...
@Component({
  selector: 'app-pre-medicine-notification',
  templateUrl: './pre-medicine-notification.component.html',
  styleUrls: ['./pre-medicine-notification.component.sass']
})
export class PreMedicineNotificationComponent implements OnInit {
  Users: USERS[];
