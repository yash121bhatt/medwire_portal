...
@Component({
  selector: 'app-healthdairymemberlist',
  templateUrl: './healthdairymemberlist.component.html',
  styleUrls: ['./healthdairymemberlist.component.sass']
})
export class HealthdairymemberlistComponent implements OnInit {
  Users: USERS[] = [{
