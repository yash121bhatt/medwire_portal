...
@Component({
  selector: 'app-latest-test-report',
  templateUrl: './latest-test-report.component.html',
  styleUrls: ['./latest-test-report.component.sass']
})
export class LatestTestReportComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.patientdataService.patienttestReport(testReport).subscribe(
      (result) => {
  ...
  // downloadReport(image) {
  //   if (image != '-') {
  //     this.htmlReturn = '<i class="fa fa-download file-style col-grey font-20"></i>';
  //   }
  //   else {
  //     this.htmlReturn = '-';
  //   }
