...
@Component({
  selector: 'app-vacination-report',
  templateUrl: './vacination-report.component.html',
  styleUrls: ['./vacination-report.component.sass']
})
export class VacinationReportComponent {
  Users: USERS[] = [{
