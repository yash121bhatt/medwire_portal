...
@Component({
  selector: 'app-discharge-m-summary',
  templateUrl: './discharge-m-summary.component.html',
  styleUrls: ['./discharge-m-summary.component.sass']
})
export class DischargeMSummaryComponent  {
  ...
  onSubmit(fData: any,formDirective: FormGroupDirective) {
    ...
    if (this.labreportForm.invalid) {
      ...
      this.form.append('type','discharge_summary');
