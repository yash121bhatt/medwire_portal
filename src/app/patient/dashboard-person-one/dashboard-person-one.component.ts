...
@Component({
  selector: 'app-dashboard-person-one',
  templateUrl: './dashboard-person-one.component.html',
  styleUrls: ['./dashboard-person-one.component.sass']
})
export class DashboardPersonOneComponent implements OnInit {
