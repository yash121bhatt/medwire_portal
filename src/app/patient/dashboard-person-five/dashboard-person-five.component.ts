...
@Component({
  selector: 'app-dashboard-person-five',
  templateUrl: './dashboard-person-five.component.html',
  styleUrls: ['./dashboard-person-five.component.sass']
})
export class DashboardPersonFiveComponent implements OnInit {
