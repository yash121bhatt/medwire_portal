...
@Component({
  selector: 'app-bpmeasure-member',
  templateUrl: './bpmeasure-member.component.html',
  styleUrls: ['./bpmeasure-member.component.sass']
})
export class BpmeasureMemberComponent implements OnInit {
  Users: USERS[] = [{
