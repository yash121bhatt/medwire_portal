...
import { BulkReportService } from './bulk-report/bulk-report.service';
...
@NgModule({
  declarations: [
    ...
    NewVisitComponent,
    BulkReportComponent,
    LabmyprofileComponent,
    LabeditprofileComponent,
  ...
  providers: [AppointmentsService, BulkReportService],
})
