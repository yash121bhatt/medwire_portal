...
@Component({
  selector: 'app-labeditprofile',
  templateUrl: './labeditprofile.component.html',
  styleUrls: ['./labeditprofile.component.sass']
})
        ...
        (result) => {
          this.http.post<any>(`${environment.apiUrl}auth/profile`, {
            ...
            (result_profile) => {
              ...
              setTimeout(() => {
                this.router.navigate(["/doctor/labmyprofile"]).then(() => {
