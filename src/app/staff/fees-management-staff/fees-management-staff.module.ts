...
import { FeesManagementStaffRoutingModule } from './fees-management-staff-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    MatExpansionModule,
    MatSortModule,
    FeesManagementStaffRoutingModule
  ]
})
export class FeesManagementStaffModule { }
